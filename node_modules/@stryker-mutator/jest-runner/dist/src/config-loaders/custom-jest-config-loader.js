...
export class CustomJestConfigLoader {
    ...
    resolvePackageJsonFilePath() {
        ...
        if (packageJsonCandidate.endsWith('package.json') && ((_b = jestOptions.jest.configFile) !== null && _b !== void 0 ? _b : fs.existsSync(packageJsonCandidate))) {
    ...
    resolveJestConfigFilePath() {
        ...
        if (!configFileCandidate.endsWith('package.json') && ((_b = jestOptions.jest.configFile) !== null && _b !== void 0 ? _b : fs.existsSync(configFileCandidate))) {
