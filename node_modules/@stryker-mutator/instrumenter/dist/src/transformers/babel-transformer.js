        ...
        for (const mutator of mutators) {
            for (const replacement of mutator.mutate(node)) {
                yield {
                    ...
                    ignoreReason: (_b = (_a = directiveBookkeeper.findIgnoreReason(node.node.loc.start.line, mutator.name)) !== null && _a !== void 0 ? _a : findExcludedMutatorIgnoreReason(mutator.name)) !== null && _b !== void 0 ? _b : ignorerBookkeeper.currentIgnoreMessage,
                };
            }
        }
